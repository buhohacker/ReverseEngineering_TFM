...
# TODO: Devolver un fihero csv con resultados obtenidos --> OK!!!
# TODO: Ver pq los prints de CSV se imprimen doble --> OK!!!
# TODO: Si resulta que el fichero esta vacio --> no hay x libreria --> eliminar fichero?
