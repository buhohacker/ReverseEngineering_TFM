...
# TODO: Ventana de aviso para ver si están modificadas las rutas? Ver si se puede con var entorno
# TODO: si se ejecuta el script desde Descargas? --> Mover scripts a home o haer que funcione desde Descargas
