...
# TODO: Si no estan creados los directorios necesarios crearlos directamente aqui? --> whoami
# TODO: Como eliminar directorios APKs de Code si se han quedado de anterior ejc pero ya no están esas APKs
# TODO: Opciones de usuario para escoger ver librerias "antiguas" o "nuevas" --> Por cantidad de librerias?
